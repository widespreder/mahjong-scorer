...
`;
  ...
  const TERM_DATA = [
    ...
    { kanji: "後付け", yomi: "アトヅケ", cat: "鳴き", desc: "役が未確定のまま鳴き、あとから役を確定させること", detail: "アガリの役が確定しないまま鳴いて手を進め、あとから役を確定させる打ち方です。たとえば中を1枚持った状態でタンヤオもない手を鳴き、あとで中をポンして役をつける、といった形です。完全先付けルールでは禁止されますが、現在の一般的なルールでは認められています。", abbr: "「アトヅケ」。後付けと喰いタンの可否を組み合わせて、両方ありなら「アリアリ」、両方なしなら「ナシナシ」と呼びます。" },
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <button style={{ ...actionBtn("p"), marginTop: 16 }} onClick={() => setShowRuleCheck(false)}>閉じる</button>
